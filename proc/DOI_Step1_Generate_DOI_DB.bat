...
export INFORMALOG=log/DOI_Step1_Generate_DB.log

re mEste arquivo é uma chamada para o 
rem rem DOI_Step1_Generate_DOI_DB.bat com parâmetros STANDARD

echo === ATENCAO ===
echo 
echo Este arquivo executara o seguinte comando
echo DOI_Step1_Generate_DOI_DB.bat .. append/reset
echo 
...
cisis/mx seq=temp/doi/step1/doi.seq "proc=@prc/doi_create_register.prc" create=../bases-work/doi/new_doi now -all
