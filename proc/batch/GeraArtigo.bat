...
$CISIS_DIR/mx $1/serial/title/title lw=0 "pft=if v50='C' then 'call batch/AppendMaster.bat ../bases-work/',v68,'/',v68,x1,'../bases-work/artigo/artigo',x1,'prc/d1930.prc'/ fi" now >temp/GeraArtigo.bat
