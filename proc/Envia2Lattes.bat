...
cp -p temp/transf2lattes/SciELO.txt temp/transf2lattes/SciELO.res.txt
# gzip -c temp/transf2lattes/SciELO.txt > temp/transf2lattes/SciELO.txt.gz
gzip -f temp/transf2lattes/SciELO.txt
mv temp/transf2lattes/SciELO.res.txt temp/transf2lattes/SciELO.txt
