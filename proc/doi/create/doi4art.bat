...
rem doi/create_update/ReadScilista.bat create $1 10.1590 bireme bireme303 scielo@scielo.org art pacote
rem doi/create_update/ReadScilista.bat create $1 10.1590 bireme bireme303 scielo@scielo.org art individual
