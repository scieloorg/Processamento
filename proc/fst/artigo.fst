...
4 0 mpl,'PII=',v880,'=',v700/						/* PII */

5 0 mpl,if v706='o' then 'OU=',v880 fi,

6 0 mpl,if v706='f'                     then 'SF=',v880/, fi,
6 0 mpl,if v706='h'                     then 'HR=',v880/,|HR=|v881/,|HR=|v891/, fi,
6 0 mpl,if v706='h' and p(v41)          then 'PHR=',v880/ fi,						/* idx de registro h pr  */
6 0 mpl,if v706='h' and v35='0102-7638' then replace(s('HR=',v880),'0102-7638','1678-9741')/, fi,	/* Troca de ISSN - RBCCV */
6 0 mpl,if v706='h' and v35='1807-0302' then replace(s('HR=',v880),'1807-0302','0101-8205')/, fi,	/* Troca de ISSN - SBMAC */
6 0 mpl,if v706='h' and v35='1806-1117' then replace(s('HR=',v880),'1806-1117','0102-4744')/, fi,	/* Troca de ISSN - RBEF  */
6 0 mpl,if v706='h' and v35='1678-4510' then replace(s('HR=',v880),'1678-4510','0100-879X')/, fi,	/* Troca de ISSN - BJMBR */
6 0 mpl,if v706='h' and p(v41)          then 'PR_HR=',v880/ fi,						/* idx do registro h pr  */
6 0 mpl,if v706='h' and p(v41)          then 'PR_DT=',v880*10.8, fi,					/* idx de h's pr por data qqr revista */
6 0 mpl,if v706='h' and p(v241^t)       then (if v241^t='pr' then 'AHPR=',v880/,'PR_LK='v241^i/ fi) fi,	/* idx de h's pr e indice indica o id do pr */
...
16 0 mpl,if v706='c' then 'R=',v880/, fi,				/* idx de referencias (aka citacoes) */

20 0 mpl,if v706='p' and p(v888) then 'RP=',v880 fi,

50 0 mpl,if v706='i' and v32='ahead' and a(v41) then  'AHEAD=',v35 fi	/* idx de ahead of print */
50 0 mpl,if v706='i' and v32='review'           then 'REVIEW=',v35 fi	/* idx de review */
