...
$cisis_dir/mx $database_dir/artigo/artigo "proc=@$conversor_dir/prc/Article.prc" "btell=0" "tp=h" "lw=999999" "pft=@$conversor_dir/formats/crossref_generateProcessSequence.pft" now >> $conversor_dir/shs/crossref_processSequence.sh
echo "--- Done!"
