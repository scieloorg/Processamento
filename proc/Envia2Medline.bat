...
call batch/GeraIso.bat $1/bases/title/title temp/transf2medline/titsci.iso
...
call batch/GeraIsoBool.bat $1/bases/artigo/artigo TP=l temp/transf2medline/artigol.iso

call batch/GeraIsoBool.bat $1/bases/artigo/artigo TP=c temp/transf2medline/bib4cit.iso prc/bib4cit.prc

call batch/GeraIsoBool.bat $1/bases/artigo/artigo TP=h+TP=c+TP=i temp/transf2medline/artigonp.iso
# 
# 
# 
