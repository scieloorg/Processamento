...
mx cipar=databases/google.cip $database_article "proc=@proc/Article.prc" "proc=('Ggizmo/googleSchoolar')" btell=0  "IV=$1$ and (tp=o or tp=h or tp=c or tp=r)" "proc='d32001'" lw=99999 pft=@formats/googleSchoolar_XMLPubMed.pft -all now >> output/googleSchoolar/$1.xml
