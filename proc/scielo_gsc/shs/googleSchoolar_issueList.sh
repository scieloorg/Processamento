...
mx $database_issue "proc='s'" "pft=@formats/googleSchoolar_genListIssue.pft" now > shs/issue.sh
...
mx $database_issue "proc='s'" "pft=@formats/googleSchoolar_genHTML.pft" now >> output/googleSchoolar/index.htm
